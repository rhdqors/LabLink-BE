...
public class FeedBackController {
    ...
    @PostMapping()
    public ResponseEntity addFeedBack(@AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable Long studyId, @Valid @RequestBody FeedBackRequestDto feedBackRequestDto){
